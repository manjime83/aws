...
cd ../../api-mi-paquete
docker image build -t 468253634394.dkr.ecr.us-east-1.amazonaws.com/mipaquete-prod/ecommerce .
eval $(aws ecr get-login --no-include-email --region us-east-1 --registry-ids 468253634394 --profile mipaquete-prod)
docker image push 468253634394.dkr.ecr.us-east-1.amazonaws.com/mipaquete-prod/ecommerce
